...
function prepare_flight(dest) {
    ...
    r += "<td class=\"price\"><a href=\"http://partners.api.skyscanner.net/apiservices/referral/v1.0/GB/GBP/en-GB/edi/"+city_code+"/"+ss_date+"/anytime\" class=\"btn btn-success\">&pound;"+dest.MinPrice+"</a></td>";
    r += "</tr>";
    return r;
}
