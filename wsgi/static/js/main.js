...
function prepare_flight(dest) {
    ...
    r += "<td class=\"price\"><a target=\"_blank\" href=\"http://partners.api.skyscanner.net/apiservices/referral/v1.0/GB/GBP/en-GB/edi/LHR/"+ss_date+"/anytime\" class=\"btn btn-success\">&pound;"+dest.MinPrice+"</a></td>";
    r += "</tr>";
    return r;
}
